...
$$
A equação pode ser convenientemente rearranjada elevando os dois membros ao quadrado:
$$
(x-x_0)^2 + (y-y_0)^2 = r^2
$$
Caso o **centro da circunferência** seja a origem do [[O plano coordenado|plano coordenado]] teremos:
$$
x^2 + y^2 = r^2
$$