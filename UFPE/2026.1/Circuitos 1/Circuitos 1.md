...
PERIODO: 4
---
# 1 - A abstração de circuitos
1. [[Abstração de Circuitos]]
2. [[Baterias]]
3. [[Resistores Lineares]]
4. [[Convenção de Variáveis Associadas]]
5. [[Componentes Ideais]]
6. [[Lei de Elemento]]
7. [[Representação de sinais]]
# 2 - Redes Resistivas
1. [[Terminologia]]
2. [[Lei de Kirchhoff das Correntes]]
3. [[Lei de Kirchhoff das Tensões]]
