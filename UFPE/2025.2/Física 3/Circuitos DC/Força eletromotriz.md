...
No circuito inteiro (Incluindo o circuito interno da bateria), começamos então a ter um potencial elétrico que se mantém idealmente constante, ao mensurarmos o trabalho por unidade de carga, temos o que chamamos de **força eletromotriz** (Uma péssima escolha de nome, uma vez que é um trabalho por unidade de carga e não uma força de fato), medida em *Volts* e que determina a tensão entre os terminais da bateria.