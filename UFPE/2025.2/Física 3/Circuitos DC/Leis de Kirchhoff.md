...
A contribuição de uma fonte de tensão é igual a [[Força eletromotriz]] $\varepsilon$ fornecida, sendo assim positiva caso a percorramos do negativo para o positivo e negativa caso o contrário.

A contribuição de um [[Corrente|resistor]] é, pela lei de Ohm, igual a $IR$, sendo positiva caso promova um aumento de potencial no sentido considerado e negativa caso contrário.
