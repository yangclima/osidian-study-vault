...
$$
V = \dfrac{U}{q} \implies dV = \dfrac{dU}{dq}  \implies \Delta V = -\int \limits_a^b \vec{E} \cdot d\vec{s} = V_f - V_i
$$
...
$$
V(r) = V(r) - V(\infty) = \int \limits_\infty^r \vec{E} \cdot d\vec{s} = \dfrac{kQ}{r}
$$
