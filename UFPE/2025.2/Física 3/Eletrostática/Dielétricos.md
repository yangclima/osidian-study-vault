...
Onde $\kappa_e$ é a chamada constante dielétrica do material e mensura justamente a resposta do material ao campo elétrico externo exercido sob ele, que é atenuado segundo a relação 

$$
E = \dfrac{E_0}{\kappa_e}
$$

E podemos então definir a [[Lei de Gauss]] para os dielétricos:

$$
\iint\limits_{S} \vec{E}\cdot d\vec{A} = \dfrac{Q_{enc,free}}{\kappa_e\varepsilon_0}
$$
Onde $Q_{enc,free}$ é a carga envolvida pela superfície gaussiana que está livre nos condutores (Desconsidera-se a carga induzida no dielétrico).